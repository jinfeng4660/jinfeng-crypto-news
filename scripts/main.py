...
<div class="sidebar-section"><h3>📅 财经日历</h3><div id="calendar-panel"><div class="cal-stats"><div style="font-size:11px;color:#8b949e;line-height:1.6"><span id="cal-total"><span style="color:#e1e4e8;font-weight:700">0</span> 条事件</span><br><span id="cal-days"><span style="color:#e1e4e8">0</span> 天</span> · <span id="cal-high"><span style="color:#f85149">0</span> 条高影响</span></div><div id="cal-next" style="margin-top:6px;padding:6px 8px;background:#121318;border:1px solid #1b1d23;border-radius:6px;font-size:10px;color:#8b949e">下一事件：<span id="cal-next-title" style="color:#c9d1d9">加载中…</span></div></div></div><div style="margin-top:6px;text-align:center"><a href="./calendar.html" class="cal-open-full" target="_blank">📊 打开完整日历 →</a></div></div>
</aside></div>
